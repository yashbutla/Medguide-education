            ...
            >
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-primary/5">
                <div className="flex -space-x-2">
                  <img src="/students/s1.png" alt="Student" className="w-8 h-8 rounded-full border-2 border-white shadow-sm object-cover z-30" />
                  <img src="/students/s2.png" alt="Student" className="w-8 h-8 rounded-full border-2 border-white shadow-sm object-cover z-20" />
                  <img src="/students/s3.png" alt="Student" className="w-8 h-8 rounded-full border-2 border-white shadow-sm object-cover z-10" />
                </div>
