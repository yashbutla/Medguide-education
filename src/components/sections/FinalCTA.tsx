    ...
    <section className="py-16 md:py-24 relative overflow-hidden bg-white">
      <div className="container max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="relative p-8 md:p-28 rounded-[40px] md:rounded-[60px] overflow-hidden bg-[#0F172A] text-center shadow-2xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-accent text-[9px] md:text-[10px] font-bold uppercase tracking-widest mb-6 md:mb-10">
              <Star className="w-3 h-3 fill-accent" /> Enrollment Open for 2026
            </div>
            
            <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-6 md:mb-10 leading-[1.1] tracking-tight">
              One wrong decision <br />
              <span className="text-[#D4A843]">Costs a Year.</span>
            </h2>
            
            <p className="text-sm md:text-xl text-white/60 font-normal mb-8 md:mb-14 leading-relaxed max-w-xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 px-4 md:px-0">
              <button 
                ...
                className="w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-white text-[#0F172A] text-sm md:text-base font-bold rounded-2xl md:rounded-3xl flex items-center justify-center gap-3 transition-all hover:scale-105 hover:bg-[#D4A843] hover:text-white"
              >
